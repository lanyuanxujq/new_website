...
<div id="main">
  ...
  <div id="opt_area">
    ...
    for(News_Topics t : al){
    %>
    
    	<li>&nbsp;&nbsp;&nbsp;&nbsp; <%=t.getTname() %>&nbsp;&nbsp;&nbsp;&nbsp; <a href="#">修改</a> &nbsp;&nbsp;&nbsp;&nbsp; <a  onclick="return confirm('确定要删除吗？')" href="topic_delete?id=<%=t.getTid() %>">删除</a></li>    
    ...
    <p align="right"> 当前页数:[<%=curpage %>/<%=pagenum %>]&nbsp;
     </a> <a href="topic_list.jsp?curPage=1">首页</a> 
     <% if(curpage==1){ %>
    <a href="topic_list.jsp?curPage=<%=curpage-1 %>" style="color:gray" onclick="return false">上一页</a>&nbsp;&nbsp;     
     <% }else{ %>
     <a href="topic_list.jsp?curPage=<%=curpage-1 %>">上一页</a>&nbsp;&nbsp;
     <% } %>
     <% if(curpage==pagenum){ %>
     <a href="topic_list.jsp?curPage=<%=curpage+1 %>" style="color:gray" onclick="return false">下一页</a>&nbsp;&nbsp;
     <% }else{ %>
     <a href="topic_list.jsp?curPage=<%=curpage+1 %>">下一页</a>&nbsp;&nbsp;
     <% } %>
     <a href="topic_list.jsp?curPage=<%=pagenum %>">末页</a> </p>
